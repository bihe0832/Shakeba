package com.bihe0832.shakeba.libware.file;
...
import com.bihe0832.shakeba.libware.encrypt.HexUtils;
...
public class Logger {
    ...
    public static final String DEFAULT_TAG = "SHAKEBA";
    public static final String SHAKEBA_DOCTOR_TAG = "SHAKEBA_DOCTOR";
    ...
    private static String FILE_LOG = "SHAKEBA.log";
    ...
    private static File getLogFile(Context ctx) {
        ...
        Logger.d(SHAKEBA_DOCTOR_TAG, "LogFile:" + file.toString());
        return file;
    }
