...
import com.bihe0832.shakeba.framework.request.HttpResponseHandler;
import com.bihe0832.shakeba.framework.request.ShakebaServer;
...
public class ShakebaUpdate {
    ...
    public void checkUpdate(final Activity activity, boolean isAuto){
        ...
        ShakebaServer.getInstance().doRequest(checkRequest);
