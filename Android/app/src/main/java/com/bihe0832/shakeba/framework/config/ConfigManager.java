package com.bihe0832.shakeba.framework.config;
...
import com.bihe0832.shakeba.libware.util.CommonUtils;
...
/**
 * Manager config, pull new config from network and broadcast to modules.
 */
public class ConfigManager {
	private static volatile ConfigManager instance = null;
	private static final String TAG = "SHAKEBA_ConfigManager";
