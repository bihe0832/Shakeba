package com.bihe0832.shakeba.framework.fragment.base;
...
public abstract class WebViewFragment extends BaseFragment {
    ...
    private void resetCacheType() {
        //设置缓存类型
        //FIXME 缓存设置
//        if (NetworkUntils.isNetworkAvailable(Shakeba.getInstance().getApplicationContext())) {
...
//            MainActivity.this.setTitle(title);
        ...
        public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
            Logger.e("onJsAlert " + message);
//            ToastUtil.show(WebViewActivity.this, message, Toast.LENGTH_SHORT);
            result.confirm();
            return true;
        }
